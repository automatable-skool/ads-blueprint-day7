...
function IconButton({
  ...
  const tone = {
    ...
    brand: {
      background: "var(--surface-brand)",
      border: "var(--border-hairline) solid var(--surface-brand)",
      color: "var(--text-inverse)"
    }
  }[variant];
  const hoverTone = {
...
function StudioWords() {
  return /*#__PURE__*/React.createElement("section", {
    ...
    icon: "quote"
  }, "Kind words"), /*#__PURE__*/React.createElement("h2", {
    style: {
      margin: 0
    }
...
function EnquiryField({
  ...
  return /*#__PURE__*/React.createElement("label", {
    ...
    style: {
      ...
      alignItems: "center",
      gap: 6,
      font: "var(--weight-semibold) 13px/1.2 var(--font-core)",
      color: "var(--text-strong)"
    }
  }, icon ? /*#__PURE__*/React.createElement(Icon, {
    name: icon,
    size: 14,
    color: "var(--text-brand)"
  }) : null, label, required ? /*#__PURE__*/React.createElement("span", {
    style: {
      color: "var(--text-brand)"
    }
  }, "*") : null), children);
...
function StudioEnquiry({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    icon: "mail"
  }, "Enquire"), /*#__PURE__*/React.createElement("h2", {
    style: {
      margin: 0,
      maxWidth: "18ch"
    }
  ...
  }, "Tell us the date and roughly what you're planning. You'll hear back within a day, from one of us, not an assistant."), /*#__PURE__*/React.createElement(AvatarCluster, {
    people: ["DR", "MT", "PS"],
    rating: "4.9",
    label: "118 couples, 118 replies within a day"
  }), /*#__PURE__*/React.createElement(MediaFrame, {
    ratio: "4 / 3",
  ...
  }, "Tell us about your day"), /*#__PURE__*/React.createElement("span", {
    style: {
      font: "var(--type-body-sm)",
      color: "var(--text-muted)"
    }
  }, "Two minutes. No obligation.")), /*#__PURE__*/React.createElement(Badge, {
    tone: "positive",
    dot: true,
    style: {
      marginLeft: "auto"
    }
  }, "2027 open")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, /*#__PURE__*/React.createElement(EnquiryField, {
    label: "Your names",
    icon: "user",
    required: true,
    span: true
  }, /*#__PURE__*/React.createElement(FilledInput, {
  ...
  }, ["Reply within a day", "No deposit to hold a date", "We answer, not a bot"].map(t => /*#__PURE__*/React.createElement("span", {
    key: t,
    style: {
      display: "inline-flex",
      alignItems: "center",
