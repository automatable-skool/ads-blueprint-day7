// The style picker - DEV ONLY. Browse /bold and /calm, answer /api-setup's
// "bold or calm?" question, and the real homepage (app/page.tsx) renders from
// lib/site.config.ts. This route 404s in production: a deployed homepage once
// said "Pick the site you want" to anyone who opened it, reviewer included
// (3 September 2026). Never link to it from the site.
    ...
    >
      <div style={{ maxWidth: "980px", margin: "0 auto" }}>
        ...
        >
          ...
          business, then run <code>/standard-pages</code> and it swaps every placeholder for
          the real thing.
        </p>
        ...
        <p style={{ marginTop: "16px", font: "var(--type-body-sm)", color: "var(--text-muted, #73726e)" }}>
          ...
          pages already - <code>/standard-pages</code> fills them from your keyword map.
        </p>
      </div>
    </main>
  );
