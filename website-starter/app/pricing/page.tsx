...
// /standard-pages fills it with the real business; until then it stays honest.
  ...
  return (
    <main style={{ maxWidth: 720, margin: "0 auto", padding: "96px 24px", fontFamily: "var(--font-core, system-ui)" }}>
      ...
      <p style={{ color: "var(--text-body, #3f3f3c)" }}>
        Filled by <code>/standard-pages</code> from the services and prices in <code>context/business.md</code>. Until then, the homepage service cards carry the from-prices.
      </p>
