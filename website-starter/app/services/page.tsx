...
//
// /standard-pages Step 2 replaces the three placeholder sections below with one
...
export const metadata = {
  title: "Services",
  description: "Every service, in one place. Filled from your keyword map by /standard-pages.",
};
...
const SERVICES = [
  { name: "Service one", blurb: "Two to four sentences on what this service is and who it is for. /standard-pages fills this from your keyword map - every service hub in the map gets a section here, linking to its own page.", frame: "Job photo" },
      ...
      <section style={{ padding: "var(--space-9, 88px) 0 var(--space-7, 48px)" }}>
        <div style={wrap}>
          ...
          <p style={body}>
            ...
            site&rsquo;s structure - run <code>/standard-pages</code> and each section below becomes
