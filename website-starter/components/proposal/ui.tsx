...
.pp-2up{display:grid;gap:16px}
@media(min-width:760px){.pp-2up{grid-template-columns:repeat(2,1fr);align-items:stretch}}
...
export function Scroller({ children }: { children: ReactNode }) {
  return <div style={{ overflowX: "auto", WebkitOverflowScrolling: "touch", minWidth: 0, maxWidth: "100%" }}>{children}</div>;
}
