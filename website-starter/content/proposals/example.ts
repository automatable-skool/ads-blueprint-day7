...
export const example: ProposalData = {
  ...
  proof: {
    items: [
      {
        name: "Dana Whitfield",
        business: "Dental clinic, Springfield",
        result: "$50,000+ a year saved",
        detail: "Replaced two admin roles with automated follow-up. 12+ leads a week, every one answered, with a 100% show rate.",
        quote: "Saved $50,000+ a year by replacing admin staff.",
        photoUrl: "/images/proof/dana-whitfield.jpg",
        videoUrl: "https://youtu.be/EXAMPLE",
        videoThumbUrl: "https://img.youtube.com/vi/EXAMPLE/hqdefault.jpg",
        disclaimer: "Results vary. This is one client's outcome, not a typical or promised result.",
      },
      {
        name: "Sam Okafor",
        business: "Ridgeway Exteriors - roofing and siding",
        ...
        photoUrl: "/images/proof/sam-okafor.jpeg",
        videoUrl: "https://youtu.be/EXAMPLE",
        videoThumbUrl: "https://img.youtube.com/vi/EXAMPLE/hqdefault.jpg",
        disclaimer: "Results vary. This is one client's outcome, not a typical or promised result.",
      },
